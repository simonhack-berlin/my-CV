...
<b>Projects:</b> E-Commerce Fashion Shop (MERN full-stack app) | Bee-travel (full-stack travel planning app) | Bricks Breaker game (HTML, JS, P5.js library) | Personal Portfolio (HTML, CSS, JS)
...
<b>Projects:</b> Fashion blog (HTML & CSS) | City blog (HTML & CSS) | Festival schedule (HTML & CSS) | Sleep Debt calculator (JavaScript) | Rock, Paper, Scissors (JavaScript) | Codebrainery.io (HTML, CSS, JS) | Amazing Space (HTML, CSS, JS)
